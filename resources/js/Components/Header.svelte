...
<header class="bg-gray-900">
    ...
    <div class="lg:hidden" role="dialog" aria-modal="true">
      ...
      <div class="fixed inset-0 z-10 bg-gray-800/80" on:click={toggleMobileMenu}></div>
      <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
        <div class="flex items-center justify-between flex-row-reverse">
          <button type="button" class="-m-2.5 rounded-md p-2.5 text-gray-400" on:click={toggleMobileMenu}>
